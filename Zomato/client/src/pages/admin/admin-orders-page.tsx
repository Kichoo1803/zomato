...
export const AdminOrdersPage = () => {
  ...
  const handleSaveOrder = async () => {
    ...
    try {
      const latestOrder =
        statusDraft && statusDraft !== selectedOrder.status
          ? await updateOrderStatus(selectedOrder.id, { status: statusDraft })
          : selectedOrder;
            ...
            <AdminDetailsGrid
              items={[
                { label: "Restaurant", value: selectedOrder.restaurant.name },
                {
                  ...
                  value: (
                    <StatusPill
                      label={toLabel(selectedOrder.status)}
                      tone={getToneForStatus(selectedOrder.status)}
                    />
                  ),
                },
                {
                ...
                { label: "Placed at", value: formatDateTime(selectedOrder.orderedAt) },
                {
                  ...
                  value: selectedOrder.deliveryPartner?.user.fullName ?? "Auto-matching rider",
                },
                {
              ...
              <AdminDetailsGrid
                ...
                items={[
                  ...
                  },
                  {
                    ...
                    value:
                      selectedOrder.restaurant.latitude != null &&
                      selectedOrder.restaurant.longitude != null
                  ...
                  },
                  {
                    ...
                    value:
                      selectedOrder.address.latitude != null &&
                      selectedOrder.address.longitude != null

...
export const AdminCombosPage = () => {
  ...
  const loadData = async () => {
    ...
    try {
      ...
      toast.error(getApiErrorMessage(error, "Unable to load combo offers."));
    } finally {
      setIsLoading(false);
    }
  };
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    if (!form.restaurantId) {
      toast.error("Choose a restaurant for this combo.");
      return;
    }
  ...
  return (
    <div className="space-y-8">
      <SectionHeading
        eyebrow="Combos"
        title="Meal bundles and upsell-ready combo offers."
        description="Platform-wide combo management for curated meals, offer pricing, and included item bundles."
        action={
      ...
      {isLoading ? (
        ...
        <>
          <AdminDataTable
            ...
            emptyDescription="Create a combo offer or broaden the current filters."
            columns={[
              {
                key: "combo",
                label: "Combo",
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          ...
          <SurfaceCard className="space-y-4">
            <SectionHeading
              ...
              description="Select menu items from the chosen restaurant and set quantities for the combo."
            />
      ...
      <ConfirmDangerModal
        ...
        title="Delete combo"
        description="This permanently removes the combo and its bundled item mapping from the platform."

...
const envSchema = z.object({
  ...
  ALLOWED_CLIENT_ORIGINS: z.string().optional(),
  ...
  RESTAURANT_DISCOVERY_DEFAULT_RADIUS_KM: z.coerce.number().positive().default(10),
  RESTAURANT_DISCOVERY_MAX_RADIUS_KM: z.coerce.number().positive().default(10),
  DELIVERY_ASSIGNMENT_RADII_KM: z.string().default("3"),

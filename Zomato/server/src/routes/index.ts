...
import {
  adminEventsRouter,
  adminEventTemplatesRouter,
  eventsRouter,
  ownerEventsRouter,
  ownerEventTemplatesRouter,
...
apiRouter.use("/admin/event-templates", adminEventTemplatesRouter);
apiRouter.use("/owner/events", ownerEventsRouter);
apiRouter.use("/owner/event-templates", ownerEventTemplatesRouter);
